  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center text-white">
      <div className="container mx-auto p-8 text-center">
        <h1 className="flex justify-center neon-text text-4xl uppercase font-semibold mb-32">Email Confirmado com Sucesso!</h1>
        <p className="text-2xl font-semibold mb-8 text-white">
          Seu email foi confirmado com sucesso!
        </p>
        <p className="text-2xl font-semibold mb-32 text-white">
          Você agora pode aproveitar os recursos da nossa aplicação.
        </p>
        <button
