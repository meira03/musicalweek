...
export default async function SalasLayout({ children, params: { lang } }) {
  ...
  return (
    <div className="py-10 mx-3 sm:mx-auto sm:max-w-4xl">
      <NavSalas padrao={salas.salas.length > 0} artista={salas.salas_artista.length > 0} fila={salas.filas.length > 0} historico={salas.historico.length > 0} minhas_salas={salas.minhas_salas.length > 0} dict={dict.components_salas_navegacao} />
